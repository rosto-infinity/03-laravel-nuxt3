...
<template>
  <div
    class="relative flex items-top justify-center min-h-screen bg-green-950 sm:items-center sm:pt-0"
  >

    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-green-600">
      <a
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to your Laravel and Nuxt Application
        </h2>
      </div>

      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/rosto-infinity" target="_blank"
          ><svg
